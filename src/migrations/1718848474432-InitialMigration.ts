...
export class InitialMigration1718848474432 implements MigrationInterface {
    name = 'InitialMigration1718848474432'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "emails" ("id" SERIAL NOT NULL, "title" character varying(255), "body" text, "subject" text, "image" bytea, "html_file" bytea, "receivers" text NOT NULL, "create_date" TIMESTAMP NOT NULL DEFAULT now(), "update_date" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_a54dcebef8d05dca7e839749571" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "schedules" ("id" SERIAL NOT NULL, "send_date" date NOT NULL, "send_time" TIME NOT NULL, "status" character varying(50) NOT NULL, "error" text, "create_date" TIMESTAMP NOT NULL DEFAULT now(), "update_date" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_7e33fc2ea755a5765e3564e66dd" PRIMARY KEY ("id"))`);
    }
